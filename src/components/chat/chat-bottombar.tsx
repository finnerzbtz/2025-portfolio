  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="relative w-full md:px-4">
        <div className="mx-auto flex items-center rounded-3xl border border-[#E5E5E9]/50 bg-[#ECECF0]/60 py-3 pr-3 pl-6 backdrop-blur-md shadow-sm">
          <input
            ref={inputRef}
            type="text"
            value={input}
          ...
          <button
            ...
            className="flex items-center justify-center rounded-full bg-[#0171E3] p-2.5 text-white shadow-sm transition-all duration-200 ease-in-out disabled:opacity-50 hover:bg-[#015CB8] hover:shadow-md"
            onClick={(e) => {
              if (isLoading) {
                e.preventDefault();
                stop();
